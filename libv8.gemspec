...
Gem::Specification.new do |s|
  ...
  s.authors     = ["Charles Lowell", "stereobooster"]
  s.email       = ["cowboyd@thefrontside.net", "stereobooster@gmail.com"]
  s.homepage    = "https://github.com/stereobooster/libv8/tree/libv8-st"
